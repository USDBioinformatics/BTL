...
@Named("toolBetsEntityController")
@SessionScoped
public class ToolBetsEntityController implements Serializable {

    @EJB
    private edu.usd.btl.toolbets.ToolBetsEntityFacade ejbFacade;
    ...
    public ToolBetsEntity getToolBetsEntity(java.lang.Integer id) {
    ...
    public static class ToolBetsEntityControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getToolBetsEntity(getKey(value));
        }
